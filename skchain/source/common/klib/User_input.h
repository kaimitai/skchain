...
namespace klib {
	...
	namespace c {
		...
		const std::map<SDL_Scancode, int> KEY_DELAYS{ {SDL_SCANCODE_LEFT, DEFAULT_KRV}, {SDL_SCANCODE_DOWN, DEFAULT_KRV}, {SDL_SCANCODE_RIGHT, DEFAULT_KRV}, {SDL_SCANCODE_UP, DEFAULT_KRV}, {SDL_SCANCODE_PAGEDOWN, 2 * DEFAULT_KRV},{SDL_SCANCODE_PAGEUP, 2 * DEFAULT_KRV}, {SDL_SCANCODE_HOME, DEFAULT_KRV},{SDL_SCANCODE_END, DEFAULT_KRV}, {SDL_SCANCODE_KP_MINUS, DEFAULT_KRV}, {SDL_SCANCODE_KP_PLUS, DEFAULT_KRV}, {SDL_SCANCODE_ESCAPE, 0}, // movement keys
			...
			{SDL_SCANCODE_1, 0},{SDL_SCANCODE_2, 0},{SDL_SCANCODE_3, 0},
