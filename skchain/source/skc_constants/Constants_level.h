...
namespace skc {
	...
	namespace c {
		...
		constexpr byte ITEM_OFFSET_SPAWN02_ENEMIES{ ITEM_OFFSET_SPAWN01_SCHEDULE + 1 };
		constexpr byte ITEM_OFFSET_SPAWN01_ENEMIES{ ITEM_OFFSET_SPAWN02_ENEMIES + 1 };
		constexpr byte ITEM_OFFSET_KEY_STATUS{ ITEM_OFFSET_SPAWN01_ENEMIES + 1 };
